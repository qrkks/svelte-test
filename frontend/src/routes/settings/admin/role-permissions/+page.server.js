...
export const actions = {
    async save({ request }) {
        ...
        if (roleType === 'system') {
            ...
            await db.delete(table.organizationRolePermissionLink)
                .where(eq(table.organizationRolePermissionLink.organizationRoleId, roleId));
            if (permissions.length) {
            ...
            await db.delete(table.subOrganizationRolePermissionLink)
                .where(eq(table.subOrganizationRolePermissionLink.subOrganizationRoleId, roleId));
            if (permissions.length) {
