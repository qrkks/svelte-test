...
// 基本类型
export const count = createLocalState('count', 0);
export const theme = createLocalState('theme', 'light');
export const isLoggedIn = createLocalState('isLoggedIn', false);

// 复杂对象
export const user = createLocalState('user', {
    name: '',
    email: '',
    preferences: {
        language: 'zh',
...
// 数组
export const todos = createLocalState('todos', []);

// 会话存储示例
export const tempData = createSessionState('tempData', {
    searchQuery: '',
    currentPage: 1
});
